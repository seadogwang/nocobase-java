...
public class BootstrapController {
    ...
    public ResponseEntity<?> setup() {
        ...
        // Idempotent: if any user exists, reject
        ...
        log.info("Bootstrapping admin user: email={}, nickname={}", adminEmail, adminNickname);
        ...
        try {
            ...
            log.info("Admin user bootstrapped successfully: id={}, email={}", user.getId(), adminEmail);
