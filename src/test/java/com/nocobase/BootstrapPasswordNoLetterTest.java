...
/**
 * Tests that bootstrap rejects passwords that contain no letters.
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
@ActiveProfiles("test")
class BootstrapPasswordNoLetterTest {
    ...
    static void registerProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("NOCOBASE_ADMIN_PASSWORD", () -> "12345678");
    ...
    @Test
    @DisplayName("Bootstrap: password with no letter is rejected")
    void noLetterPasswordRejected() throws Exception {
